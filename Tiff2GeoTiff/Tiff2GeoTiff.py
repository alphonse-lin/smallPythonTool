...
def readImage(img_path, output_path):
    data = []
    # 以只读方式打开遥感影像
...
if __name__ == '__main__':
    img_path = r"E:\OneDrive\桌面\testOutput\test_3_modified.tif"
    output_path = r"E:\OneDrive\桌面\testOutput\test_3_modified2.tiff"
    readImage(img_path, output_path)
